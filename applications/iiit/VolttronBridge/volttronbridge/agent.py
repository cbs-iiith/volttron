...
class VolttronBridge(Agent):
    ...
    @RPC.export('discovery_address')
    def discovery_address(self):
        return self._discovery_address

    @RPC.export('register_local_ed_agent')
    ...
    @RPC.export('unregister_local_ed_agent')
